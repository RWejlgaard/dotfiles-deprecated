...
(function() {
  ...
  Extension = class Extension {
    ...
    static trackEvent(category, action, value) {
      if (value !== void 0) { // Make it a string or leave it undefined
  ...
  Background = (function() {
    ...
    class Background {
      constructor() {
        ...
        this.getVideoIdAndCurrentTime = this.getVideoIdAndCurrentTime.bind(this);
      ...
      openPopout(request, sender, sendResponse) {
        ...
        video = new Video(request.videoId, request.currentTime, request.width, request.height);
    ...
    LISTENERS = ['getVideoIdAndCurrentTime', 'openPopout', 'videoViewed'];
